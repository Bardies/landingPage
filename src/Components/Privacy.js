      ...
      <div>
        ...
        <header className="masthead">
          <div className="container">
            <div className="masthead-subheading">Privacy And Policy</div>
          </div>
        </header>
        <div className="container text-left">
          ...
          <p>
            <strong>
              This is going to be a final year graudation project in faculty of
              engineering computer science department this project is totally
              focus on improving the quality of social communication and
              businesses through a whole system that is built as a web interface
              for normal users powered by a NLP (Natural Language Processing)
              model that is used to filter the profinity and unallowed words.
            </strong>
          </p>
          <br></br>
          <p>
            ...
            <br></br>
            Mahmoud Esmail built the toxicfiltering app as a Free app. This
            SERVICE is provided by Mahmoud Esmail at no cost and is intended for
            ...
            is accessible at toxicfiltering unless otherwise defined in this
            Privacy Policy.
          </p>
          <br></br>
          <p>
            ...
            facebookfanpageposts,facebookfanpagecomments. The information that I
          ...
          <p>
            ...
            <br></br>I want to inform you that whenever you use my Service, in a
          ...
          <p>
            ...
            <br></br>I may employ third-party companies and individuals due to
          ...
          <p>
            ...
            <br></br>I value your trust in providing us your Personal
          ...
          <p>
            ...
            <br></br>I may update our Privacy Policy from time to time. Thus,
            ...
            this page. This policy is effective as of 2020-06-03
          </p>
          <br></br>
          <p>
            ...
            <a href="MahmoudEsmail677@gmail.com" style={{ color: "blue" }}>
              MahmoudEsmail677@gmail.com.
            </a>
          </p>
        </div>
        <Footer />
