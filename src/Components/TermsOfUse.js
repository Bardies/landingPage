      ...
      <div>
        ...
        <header className="masthead">
          <div className="container">
            <div className="masthead-subheading">Terms Of Use</div>
          </div>
        </header>
        <div className=" container text-left">
          <br></br>
          <p>
            <strong>Website Terms of Use Version 1.0</strong>
          </p>
          <p>
            The toxicfiltering website located at www.to-become-domain.com is a
            copyrighted work belonging to toxicfiltering. Certain features of
          ...
          <p>
            User Content User Content. "User Content" means any and all
          ...
          <p>
            ...
            and/or reporting you to law enforcement authorities. If you provide
            Company with any feedback or suggestions regarding the Site, you
            ...
            and related information in any manner it believes appropriate.
          ...
          <br></br>
          <p>
            Third-Party Links & Ads; Other Users Third-Party Links & Ads. The
          ...
          <br></br>
          <p>Contact Information Address: 13 sabry st</p>
          <p>
            <strong>Email:</strong>
